...
demo_step 3 "Commit and Push CUE Changes"

demo_action "Creating feature branch..."
FEATURE_BRANCH="uc-c4-prometheus-annotations-$(date +%s)"
git checkout -b "$FEATURE_BRANCH"

demo_action "Committing CUE changes only (manifests generated by pipeline)..."
git add services/core/app.cue services/resources/deployment.cue
git commit -m "feat: add default Prometheus annotations to all deployments (UC-C4)"
