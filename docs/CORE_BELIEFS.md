...
- CLI wrappers over direct API calls centralize auth and error handling. Extend the wrappers when new endpoints are needed; direct API calls are not allowed. If violated, creds and API behavior diverge across scripts. (Added 2026-02-12)
